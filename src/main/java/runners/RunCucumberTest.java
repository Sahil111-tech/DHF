...
@CucumberOptions(features = "src/test/resources/Features/WebsiteSmoke.feature", glue = { "StepDefinitions" }, plugin = { "pretty",
...
publish=true, //Publishes the generated Cucumber report to a sharable URL.
		tags = /*"@CompleteMAFSubmission and @starterExtras"*/ "@CompleteMAFSubmission"
)
